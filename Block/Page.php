 ...
 * @since 100.0.2
 */
class Page extends \PassKeeper\Framework\View\Element\AbstractBlock implements
    \PassKeeper\Framework\DataObject\IdentityInterface
{
    /**
    ...
    /**
     * @var \PassKeeper\Framework\View\Page\Config
     */
     ...
     * @param \PassKeeper\Framework\View\Page\Config $pageConfig
     * @param array $data
     */
    public function __construct(
        ...
        \PassKeeper\Framework\View\Page\Config $pageConfig,
        array $data = []
    ) {
        parent::__construct($context, $data);
        // used singleton (instead factory) because there exist dependencies on \PassKeeper\Cms\Helper\Page
        $this->_page = $page;
     ...
     * @return void
     */
    protected function _addBreadcrumbs(\PassKeeper\Cms\Model\Page $page)
    {
    ...
    {
        return [\PassKeeper\Cms\Model\Page::CACHE_TAG . '_' . $this->getPage()->getId()];
    }
}
