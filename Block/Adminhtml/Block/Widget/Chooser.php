 ...
 */
namespace PassKeeper\Cms\Block\Adminhtml\Block\Widget;

/**
 * CMS block chooser for Wysiwyg CMS widget
 */
class Chooser extends \PassKeeper\Backend\Block\Widget\Grid\Extended
{
    /**
    ...
    public function __construct(
        ...
        \PassKeeper\Cms\Model\ResourceModel\Block\CollectionFactory $collectionFactory,
        array $data = []
    ) {
     ...
     *
     * @param \PassKeeper\Framework\Data\Form\Element\AbstractElement $element Form Element
     * @return \PassKeeper\Framework\Data\Form\Element\AbstractElement
     */
    public function prepareElementHtml(\PassKeeper\Framework\Data\Form\Element\AbstractElement $element)
    {
        $uniqId = $this->mathRandom->getUniqueHash($element->getId());
        $sourceUrl = $this->getUrl('cms/block_widget/chooser', ['uniq_id' => $uniqId]);

        $chooser = $this->getLayout()->createBlock(
            \PassKeeper\Widget\Block\Adminhtml\Widget\Chooser::class
        )->setElement(
            $element
        )->setConfig(
            $this->getConfig()
