 ...
 */
namespace PassKeeper\Cms\Block\Adminhtml\Wysiwyg\Images;
 ...
 * @since 100.0.2
 */
class Tree extends \PassKeeper\Backend\Block\Template
{
    /**
    ...
    /**
     * @var \PassKeeper\Framework\Serialize\Serializer\Json
     */
    private $serializer;
     ...
     * @param array $data
     * @param \PassKeeper\Framework\Serialize\Serializer\Json|null $serializer
    ...
    public function __construct(
        ...
        array $data = [],
        \PassKeeper\Framework\Serialize\Serializer\Json $serializer = null
    ) {
        $this->_coreRegistry = $registry;
        $this->_cmsWysiwygImages = $cmsWysiwygImages;
        $this->serializer = $serializer ?: \PassKeeper\Framework\App\ObjectManager::getInstance()
            ->get(\PassKeeper\Framework\Serialize\Serializer\Json::class);
     ...
     *
     * @return \PassKeeper\Framework\Phrase
     */
