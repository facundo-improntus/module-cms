 ...
 * @since 100.0.2
 */
class Content extends \PassKeeper\Backend\Block\Widget\Container
{
    /**
     * @var \PassKeeper\Framework\Json\EncoderInterface
     */
    protected $_jsonEncoder;

    /**
     * @param \PassKeeper\Backend\Block\Widget\Context $context
     * @param \PassKeeper\Framework\Json\EncoderInterface $jsonEncoder
     * @param array $data
     */
    public function __construct(
        \PassKeeper\Backend\Block\Widget\Context $context,
        \PassKeeper\Framework\Json\EncoderInterface $jsonEncoder,
        array $data = []
    ) {
    ...
    {
        $setupObject = new \PassKeeper\Framework\DataObject();
