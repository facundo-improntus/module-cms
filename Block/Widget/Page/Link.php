 ...
 */
namespace PassKeeper\Cms\Block\Widget\Page;

/**
 * Widget to display link to CMS page
 */
class Link extends \PassKeeper\Framework\View\Element\Html\Link implements \PassKeeper\Widget\Block\BlockInterface
{
    /**
    ...
    /**
     * @var \PassKeeper\Cms\Model\ResourceModel\Page
     */
     ...
     * @param \PassKeeper\Cms\Model\ResourceModel\Page $resourcePage
     * @param \PassKeeper\Cms\Helper\Page $cmsPage
     * @param array $data
     */
    public function __construct(
        \PassKeeper\Framework\View\Element\Template\Context $context,
        \PassKeeper\Cms\Model\ResourceModel\Page $resourcePage,
