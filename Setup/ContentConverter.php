 ...
 */
namespace PassKeeper\Cms\Setup;

use PassKeeper\Framework\Data\Wysiwyg\Normalizer;
use PassKeeper\Framework\DB\DataConverter\DataConversionException;
use PassKeeper\Framework\DB\DataConverter\SerializedToJson;
use PassKeeper\Framework\Serialize\Serializer\Json;
use PassKeeper\Framework\Serialize\Serializer\Serialize;
use PassKeeper\Framework\Filter\Template\Tokenizer\ParameterFactory;
...
class ContentConverter extends SerializedToJson
{
    ...
    {
        /** @var \PassKeeper\Framework\Filter\Template\Tokenizer\Parameter $tokenizer */
