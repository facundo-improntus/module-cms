...
use PassKeeper\Framework\Module\Setup\Migration;
...
class CreateDefaultPages implements DataPatchInterface, PatchVersionInterface
{
    ...
    public function __construct(
        \PassKeeper\Framework\Setup\ModuleDataSetupInterface $moduleDataSetup,
        ...
        $cmsPages = [
            [
                ...
                'content' => "<dl>\r\n<dt>The page you requested was not found, and we have a fine guess why.</dt>\r\n"
                    ...
                    . " There are many ways you can get back on track with PassKeeper Store.</dd>\r\n<dd>\r\n"
