...
use PassKeeper\Framework\Model\Context;
use PassKeeper\Framework\Registry;
use PassKeeper\Framework\Model\ResourceModel\AbstractResource;
...
class Block extends AbstractModel implements BlockInterface, IdentityInterface
{
    ...
    {
        $this->_init(\PassKeeper\Cms\Model\ResourceModel\Block::class);
    }
