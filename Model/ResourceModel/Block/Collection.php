 ...
 */
namespace PassKeeper\Cms\Model\ResourceModel\Block;

use PassKeeper\Cms\Api\Data\BlockInterface;
use \PassKeeper\Cms\Model\ResourceModel\AbstractCollection;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(\PassKeeper\Cms\Model\Block::class, \PassKeeper\Cms\Model\ResourceModel\Block::class);
     ...
     * Add filter by store
     *
     * @param int|array|\PassKeeper\Store\Model\Store $store
