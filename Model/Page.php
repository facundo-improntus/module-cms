...
use PassKeeper\Cms\Model\Page\CustomLayout\CustomLayoutRepository;
...
use PassKeeper\Backend\Model\Validator\UrlKey\CompositeUrlKey;
...
class Page extends AbstractModel implements PageInterface, IdentityInterface
{
    ...
    /**
     * @param \PassKeeper\Framework\Model\Context $context
     * @param \PassKeeper\Framework\Registry $registry
     * @param \PassKeeper\Framework\Model\ResourceModel\AbstractResource|null $resource
     * @param \PassKeeper\Framework\Data\Collection\AbstractDb|null $resourceCollection
     * @param array $data
    ...
    public function __construct(
        \PassKeeper\Framework\Model\Context $context,
        \PassKeeper\Framework\Registry $registry,
        \PassKeeper\Framework\Model\ResourceModel\AbstractResource $resource = null,
        \PassKeeper\Framework\Data\Collection\AbstractDb $resourceCollection = null,
        array $data = [],
    ...
    {
        $this->_init(\PassKeeper\Cms\Model\ResourceModel\Page::class);
    }
     ...
     * Load No-Route Page
     *
     * @return \PassKeeper\Cms\Model\Page
     */
    ...
    private function getScopeConfig()
    {
        if (null === $this->scopeConfig) {
            $this->scopeConfig = \PassKeeper\Framework\App\ObjectManager::getInstance()->get(ScopeConfigInterface::class);
        }
