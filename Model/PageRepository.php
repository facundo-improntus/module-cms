...
use PassKeeper\Cms\Api\Data\PageInterfaceFactory;
use PassKeeper\Cms\Api\Data\PageSearchResultsInterface;
use PassKeeper\Cms\Api\PageRepositoryInterface;
use PassKeeper\Cms\Model\Api\SearchCriteria\PageCollectionProcessor;
use PassKeeper\Cms\Model\Page\IdentityMap;
use PassKeeper\Cms\Model\ResourceModel\Page as ResourcePage;
use PassKeeper\Cms\Model\ResourceModel\Page\CollectionFactory as PageCollectionFactory;
...
use PassKeeper\Framework\App\Route\Config;
...
class PageRepository implements PageRepositoryInterface
{
    ...
    private function getCollectionProcessor()
    {
        if (!$this->collectionProcessor) {
            // phpstan:ignore "Class PassKeeper\Cms\Model\Api\SearchCriteria\PageCollectionProcessor not found."
