...
use PassKeeper\Cms\Helper\Wysiwyg\Images;
 ...
 * @since 100.0.2
 */
class Storage extends \PassKeeper\Framework\DataObject
{
    public const DIRECTORY_NAME_REGEXP = '/^[a-z0-9\-\_]+$/si';

    public const THUMBS_DIRECTORY_NAME = '.thumbs';

    public const THUMB_PLACEHOLDER_PATH_SUFFIX = 'PassKeeper_Cms::images/placeholder_thumbnail.jpg';
     ...
     * Config object
     *
     * @var \PassKeeper\Framework\App\Config\Element
     */
    protected $_config;
    ...
    /**
     * @var \PassKeeper\Framework\Filesystem\Directory\Write
     */
    protected $_directory;

    /**
     * @var \PassKeeper\Framework\Image\AdapterFactory
     */
     ...
     *
     * @var \PassKeeper\MediaStorage\Helper\File\Storage\Database
     */
    ...
    /**
     * @var \PassKeeper\Backend\Model\Session
     */
    protected $_session;

    /**
     * @var \PassKeeper\MediaStorage\Model\File\Storage\Directory\DatabaseFactory
     */
    protected $_directoryDatabaseFactory;

    /**
     * @var \PassKeeper\MediaStorage\Model\File\Storage\DatabaseFactory
     */
    protected $_storageDatabaseFactory;

    /**
     * @var \PassKeeper\MediaStorage\Model\File\Storage\FileFactory
     */
    protected $_storageFileFactory;

    /**
     * @var \PassKeeper\Cms\Model\Wysiwyg\Images\Storage\CollectionFactory
     */
    protected $_storageCollectionFactory;

    /**
     * @var \PassKeeper\MediaStorage\Model\File\UploaderFactory
     */
    ...
    /**
     * @var \PassKeeper\Framework\Filesystem\DriverInterface
     */
    private $file;

    /**
     * @var \PassKeeper\Framework\Filesystem\Io\File|null
     */
    private $ioFile;

    /**
     * @var \PassKeeper\Framework\File\Mime|null
     */
    private $mime;
     ...
     * Construct
     *
     * @param \PassKeeper\Backend\Model\Session $session
     * @param \PassKeeper\Backend\Model\UrlInterface $backendUrl
     * @param \PassKeeper\Cms\Helper\Wysiwyg\Images $cmsWysiwygImages
     * @param \PassKeeper\MediaStorage\Helper\File\Storage\Database $coreFileStorageDb
     * @param \PassKeeper\Framework\Filesystem $filesystem
     * @param \PassKeeper\Framework\Image\AdapterFactory $imageFactory
     * @param \PassKeeper\Framework\View\Asset\Repository $assetRepo
     * @param \PassKeeper\Cms\Model\Wysiwyg\Images\Storage\CollectionFactory $storageCollectionFactory
     * @param \PassKeeper\MediaStorage\Model\File\Storage\FileFactory $storageFileFactory
     * @param \PassKeeper\MediaStorage\Model\File\Storage\DatabaseFactory $storageDatabaseFactory
     * @param \PassKeeper\MediaStorage\Model\File\Storage\Directory\DatabaseFactory $directoryDatabaseFactory
     * @param \PassKeeper\MediaStorage\Model\File\UploaderFactory $uploaderFactory
     * @param array $resizeParameters
     * @param array $extensions
     * @param array $dirs
     * @param array $data
     * @param \PassKeeper\Framework\Filesystem\DriverInterface $file
     * @param \PassKeeper\Framework\Filesystem\Io\File|null $ioFile
     * @param \Psr\Log\LoggerInterface|null $logger
     * @param \PassKeeper\Framework\File\Mime $mime
    ...
    public function __construct(
        \PassKeeper\Backend\Model\Session $session,
        \PassKeeper\Backend\Model\UrlInterface $backendUrl,
        \PassKeeper\Cms\Helper\Wysiwyg\Images $cmsWysiwygImages,
        \PassKeeper\MediaStorage\Helper\File\Storage\Database $coreFileStorageDb,
        \PassKeeper\Framework\Filesystem $filesystem,
        \PassKeeper\Framework\Image\AdapterFactory $imageFactory,
        \PassKeeper\Framework\View\Asset\Repository $assetRepo,
        \PassKeeper\Cms\Model\Wysiwyg\Images\Storage\CollectionFactory $storageCollectionFactory,
        \PassKeeper\MediaStorage\Model\File\Storage\FileFactory $storageFileFactory,
        \PassKeeper\MediaStorage\Model\File\Storage\DatabaseFactory $storageDatabaseFactory,
        \PassKeeper\MediaStorage\Model\File\Storage\Directory\DatabaseFactory $directoryDatabaseFactory,
        \PassKeeper\MediaStorage\Model\File\UploaderFactory $uploaderFactory,
        array $resizeParameters = [],
        array $extensions = [],
        array $dirs = [],
        array $data = [],
        \PassKeeper\Framework\Filesystem\DriverInterface $file = null,
        \PassKeeper\Framework\Filesystem\Io\File $ioFile = null,
        \Psr\Log\LoggerInterface $logger = null,
        \PassKeeper\Framework\File\Mime $mime = null,
        ...
        $this->_dirs = $dirs;
        $this->file = $file ?: ObjectManager::getInstance()->get(\PassKeeper\Framework\Filesystem\Driver\File::class);
        $this->ioFile = $ioFile ?: ObjectManager::getInstance()->get(\PassKeeper\Framework\Filesystem\Io\File::class);
        $this->mime = $mime ?: ObjectManager::getInstance()->get(\PassKeeper\Framework\File\Mime::class);
     ...
     * @return void
     * @throws \PassKeeper\Framework\Exception\FileSystemException
     * @throws \PassKeeper\Framework\Exception\ValidatorException
     */
    protected function createSubDirectories($path)
    {
        if ($this->_coreFileStorageDb->checkDbUsage()) {
            /** @var \PassKeeper\MediaStorage\Model\File\Storage\Directory\Database $subDirectories */
     ...
     *
     * @param \PassKeeper\Framework\Data\Collection\Filesystem $collection
    ...
    public function getDirsCollection($path)
    {
        ...
        $collection = $this->getCollection($path)
            ...
            ->setOrder('basename', \PassKeeper\Framework\Data\Collection\Filesystem::SORT_ORDER_ASC);
    ...
    public function getFilesCollection($path, $type = null)
    {
        ...
        if ($this->_coreFileStorageDb->checkDbUsage()) {
            ...
            /** @var \PassKeeper\MediaStorage\Model\File\Storage\File $fileStorageModel */
        ...
        $collection = $this->getCollection(
            ...
            'mtime',
            \PassKeeper\Framework\Data\Collection::SORT_ORDER_ASC
        );
     ...
     * @return \PassKeeper\Cms\Model\Wysiwyg\Images\Storage\Collection
     * @throws \Exception
     */
    public function getCollection($path = null)
    {
        /** @var \PassKeeper\Cms\Model\Wysiwyg\Images\Storage\Collection $collection */
    ...
    public function createDirectory($name, $path)
    {
        ...
        try {
            ...
            return $result;
        } catch (\PassKeeper\Framework\Exception\FileSystemException $e) {
            throw new \PassKeeper\Framework\Exception\LocalizedException(__('We cannot create a new directory.'));
        }
    }
    ...
    public function uploadFile($targetPath, $type = null)
    {
        ...
        /** @var \PassKeeper\MediaStorage\Model\File\Uploader $uploader */
        ...
        if (!$uploader->checkMimeType($this->getAllowedMimeTypes($type))) {
            throw new \PassKeeper\Framework\Exception\LocalizedException(__('File validation failed.'));
        }
        $result = $uploader->save($targetPath);

        if (!$result) {
            throw new \PassKeeper\Framework\Exception\LocalizedException(__('We can\'t upload the file right now.'));
        }
     ...
     * Storage session
     *
     * @return \PassKeeper\Backend\Model\Session
     */
