...
use PassKeeper\Ui\Component\Wysiwyg\ConfigInterface;
 ...
 */
class Config extends \PassKeeper\Framework\DataObject implements ConfigInterface
{
    /**
     ...
     *
     */
    const WYSIWYG_SKIN_IMAGE_PLACEHOLDER_ID = 'PassKeeper_Cms::images/wysiwyg_skin_image.png';
    ...
    /**
     * @var \PassKeeper\Framework\AuthorizationInterface
     */
    ...
    /**
     * @var \PassKeeper\Variable\Model\Variable\Config
     * @deprecated 103.0.0
     * @see \PassKeeper\Cms\Model\ConfigProvider::processVariableConfig
     */
    protected $_variableConfig;

    /**
     * @var \PassKeeper\Widget\Model\Widget\Config
     * @deprecated 103.0.0
     * @see \PassKeeper\Cms\Model\ConfigProvider::processWidgetConfig
     */
    ...
    /**
     * @var \PassKeeper\Cms\Model\Wysiwyg\CompositeConfigProvider
     */
     ...
     * @param \PassKeeper\Framework\AuthorizationInterface $authorization
     * @param \PassKeeper\Framework\View\Asset\Repository $assetRepo
     * @param \PassKeeper\Variable\Model\Variable\Config $variableConfig
     * @param \PassKeeper\Widget\Model\Widget\Config $widgetConfig
    ...
    public function __construct(
        ...
        \PassKeeper\Framework\AuthorizationInterface $authorization,
        \PassKeeper\Framework\View\Asset\Repository $assetRepo,
        \PassKeeper\Variable\Model\Variable\Config $variableConfig,
        \PassKeeper\Widget\Model\Widget\Config $widgetConfig,
        ...
        array $windowSize = [],
        array $data = [],
        \PassKeeper\Cms\Model\Wysiwyg\CompositeConfigProvider $configProvider = null
    ) {
        ...
        $this->configProvider = $configProvider ?: ObjectManager::getInstance()
            ->get(\PassKeeper\Cms\Model\Wysiwyg\CompositeConfigProvider ::class);
        parent::__construct($data);
    }

    /**
     * Return Wysiwyg config as \PassKeeper\Framework\DataObject
     *
     ...
     *
     * @param array|\PassKeeper\Framework\DataObject $data Object constructor params to override default config values
     * @return \PassKeeper\Framework\DataObject
     */
    public function getConfig($data = [])
    {
        $config = new \PassKeeper\Framework\DataObject();
        ...
        if ($this->_authorization->isAllowed('PassKeeper_Cms::media_gallery')) {
