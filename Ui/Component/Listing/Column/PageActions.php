...
use PassKeeper\Cms\Block\Adminhtml\Page\Grid\Renderer\Action\UrlBuilder;
...
class PageActions extends Column
{
    ...
    /**
     * @var \PassKeeper\Cms\Block\Adminhtml\Page\Grid\Renderer\Action\UrlBuilder
     */
    protected $actionUrlBuilder;

    /**
     * @var \PassKeeper\Cms\ViewModel\Page\Grid\UrlBuilder
     */
     ...
     * @param \PassKeeper\Cms\ViewModel\Page\Grid\UrlBuilder|null $scopeUrlBuilder
     */
    public function __construct(
        ...
        \PassKeeper\Cms\ViewModel\Page\Grid\UrlBuilder $scopeUrlBuilder = null
    ) {
        ...
        $this->scopeUrlBuilder = $scopeUrlBuilder ?: ObjectManager::getInstance()
            ->get(\PassKeeper\Cms\ViewModel\Page\Grid\UrlBuilder::class);
    }
